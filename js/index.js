...
function allTasks() {
  ...
  pendingNum.innerHTML =
    tasks.length === 0 ? "no" : `<strong>${tasks.length}</strong>`;
...
inputField.addEventListener("keyup", (e) => {
  ...
  // trim function removes space of front and back of the inputed value
  ...
  if (e.key === "Enter" && inputVal.length > 0  ) {
    ...
    // inserting li tag inside the todolist
